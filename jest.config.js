module.exports = {
  ...
  moduleNameMapper: {
    ...
    'stencil-hotfix/cli': '<rootDir>/cli/index.js',
    'stencil-hotfix/compiler': '<rootDir>/compiler/stencil.js',
    'stencil-hotfix/mock-doc': '<rootDir>/mock-doc/index.cjs',
    'stencil-hotfix/testing': '<rootDir>/testing/index.js',
